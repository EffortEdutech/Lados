...
**Generated:** 2026-07-26T03:09:23.063Z
...
- Typed configuration schemas are declared by **10** nodes; **93** configured nodes still rely wholly or partly on API-derived generic string inputs.
...
| 2 | generic_string_configuration | 93 | These configured nodes still contain fields without explicit typed schemas, so the API derives optional string controls for the remaining fields. | S27.2 |
